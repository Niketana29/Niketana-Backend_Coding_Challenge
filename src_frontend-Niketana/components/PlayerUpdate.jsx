...
class PlayerUpdate extends Component {
    ...
    componentDidMount() {
        ...
        playerApi.getPlayerById(id).then((response) => {
            const { playerId, playerName, jerseyNumber, role } = response.data;
            this.setState({ playerId, playerName, jerseyNumber, role });
        });
    }
    ...
    handleSubmit = e => {
        ...
        const player = { playerId, playerName, jerseyNumber: Number(jerseyNumber), role };
        playerApi.updatePlayer(player)
            .then(() => this.props.navigation.navigate("/players"))
            .catch((err) => alert("Error updating player. Check console."));
    };

    render() {

        const { playerId, playerName, jerseyNumber, role, errors } = this.state;
            ...
            <div className="container mt-3">
                ...
                <form onSubmit={this.handleSubmit} noValidate>
                    <div className="form-group mb-3">
                        ...
                        <input type="text" name="playerId" className="form-control" value={playerId} readOnly />
                    </div>
                    <div className="form-group mb-3">
...
export default withNavigation(PlayerUpdate);